...
这种投影方式的特征在于，能保持变换前后，物体所占的立体角大小不变。或者说，在半球空间中，半球面上两个**面积相同**的图案，**成像后，在成像平面上的两个图案的面积仍然相同**（虽然两者形状不一定相似）
